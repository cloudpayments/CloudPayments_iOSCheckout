...
extension NetworkService {
    ...
    func charge(cardCryptogramPacket: String, cardHolderName: String, completion: @escaping (Result<TransactionResponse>) -> Void) {
    ...
    func auth(cardCryptogramPacket: String, cardHolderName: String, completion: @escaping (Result<TransactionResponse>) -> Void) {
